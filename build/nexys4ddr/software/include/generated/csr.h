...
/* servo_driver */
#define CSR_SERVO_DRIVER_BASE (CSR_BASE + 0x3000L)
#define CSR_SERVO_DRIVER_CTR_ADDR (CSR_BASE + 0x3000L)
#define CSR_SERVO_DRIVER_CTR_SIZE 1
static inline uint32_t servo_driver_ctr_read(void) {
	return csr_read_simple(CSR_BASE + 0x3000L);
}
static inline void servo_driver_ctr_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3000L);
}

/* us_driver */
#define CSR_US_DRIVER_BASE (CSR_BASE + 0x3800L)
#define CSR_US_DRIVER_MEDIDA_ADDR (CSR_BASE + 0x3800L)
#define CSR_US_DRIVER_MEDIDA_SIZE 1
static inline uint32_t us_driver_medida_read(void) {
	return csr_read_simple(CSR_BASE + 0x3800L);
}

/* uart1 */
#define CSR_UART1_BASE (CSR_BASE + 0x4800L)
#define CSR_UART1_RXTX_ADDR (CSR_BASE + 0x4800L)
...
#define CSR_UART1_EV_PENDING_ADDR (CSR_BASE + 0x4810L)
...
#define CSR_UART1_EV_ENABLE_ADDR (CSR_BASE + 0x4814L)
