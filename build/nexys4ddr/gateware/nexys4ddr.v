...
reg  [15:0] basesoc_leds_storage = 16'd0;
reg  basesoc_leds_re = 1'd0;
wire [15:0] basesoc_switchs_status;
...
reg  [2:0] basesoc_servo_driver_storage = 3'd0;
reg  basesoc_servo_driver_re = 1'd0;
wire [7:0] basesoc_us_driver_status;
wire basesoc_us_driver_we;
reg  basesoc_us_driver_re = 1'd0;
...
reg  builder_csrbank3_r_enable0_re = 1'd0;
wire builder_csrbank3_r_enable0_r;
reg  builder_csrbank3_r_enable0_we = 1'd0;
wire builder_csrbank3_r_enable0_w;
reg  builder_csrbank3_r_width0_re = 1'd0;
wire [31:0] builder_csrbank3_r_width0_r;
reg  builder_csrbank3_r_width0_we = 1'd0;
wire [31:0] builder_csrbank3_r_width0_w;
reg  builder_csrbank3_r_period0_re = 1'd0;
wire [31:0] builder_csrbank3_r_period0_r;
reg  builder_csrbank3_r_period0_we = 1'd0;
wire [31:0] builder_csrbank3_r_period0_w;
reg  builder_csrbank3_g_enable0_re = 1'd0;
wire builder_csrbank3_g_enable0_r;
reg  builder_csrbank3_g_enable0_we = 1'd0;
wire builder_csrbank3_g_enable0_w;
reg  builder_csrbank3_g_width0_re = 1'd0;
wire [31:0] builder_csrbank3_g_width0_r;
reg  builder_csrbank3_g_width0_we = 1'd0;
wire [31:0] builder_csrbank3_g_width0_w;
reg  builder_csrbank3_g_period0_re = 1'd0;
wire [31:0] builder_csrbank3_g_period0_r;
reg  builder_csrbank3_g_period0_we = 1'd0;
wire [31:0] builder_csrbank3_g_period0_w;
reg  builder_csrbank3_b_enable0_re = 1'd0;
wire builder_csrbank3_b_enable0_r;
reg  builder_csrbank3_b_enable0_we = 1'd0;
wire builder_csrbank3_b_enable0_w;
reg  builder_csrbank3_b_width0_re = 1'd0;
wire [31:0] builder_csrbank3_b_width0_r;
reg  builder_csrbank3_b_width0_we = 1'd0;
wire [31:0] builder_csrbank3_b_width0_w;
reg  builder_csrbank3_b_period0_re = 1'd0;
wire [31:0] builder_csrbank3_b_period0_r;
reg  builder_csrbank3_b_period0_we = 1'd0;
wire [31:0] builder_csrbank3_b_period0_w;
...
wire [15:0] builder_csrbank5_out0_r;
reg  builder_csrbank5_out0_we = 1'd0;
wire [15:0] builder_csrbank5_out0_w;
...
reg  builder_csrbank6_ctr0_re = 1'd0;
wire [2:0] builder_csrbank6_ctr0_r;
reg  builder_csrbank6_ctr0_we = 1'd0;
wire [2:0] builder_csrbank6_ctr0_w;
...
wire [15:0] builder_csrbank7_in_r;
reg  builder_csrbank7_in_we = 1'd0;
wire [15:0] builder_csrbank7_in_w;
...
reg  builder_csrbank8_load0_re = 1'd0;
wire [31:0] builder_csrbank8_load0_r;
reg  builder_csrbank8_load0_we = 1'd0;
wire [31:0] builder_csrbank8_load0_w;
reg  builder_csrbank8_reload0_re = 1'd0;
wire [31:0] builder_csrbank8_reload0_r;
reg  builder_csrbank8_reload0_we = 1'd0;
wire [31:0] builder_csrbank8_reload0_w;
reg  builder_csrbank8_en0_re = 1'd0;
wire builder_csrbank8_en0_r;
reg  builder_csrbank8_en0_we = 1'd0;
wire builder_csrbank8_en0_w;
reg  builder_csrbank8_update_value0_re = 1'd0;
wire builder_csrbank8_update_value0_r;
reg  builder_csrbank8_update_value0_we = 1'd0;
wire builder_csrbank8_update_value0_w;
reg  builder_csrbank8_value_re = 1'd0;
wire [31:0] builder_csrbank8_value_r;
reg  builder_csrbank8_value_we = 1'd0;
...
reg  builder_csrbank9_txfull_re = 1'd0;
wire builder_csrbank9_txfull_r;
reg  builder_csrbank9_txfull_we = 1'd0;
wire builder_csrbank9_txfull_w;
reg  builder_csrbank9_rxempty_re = 1'd0;
wire builder_csrbank9_rxempty_r;
reg  builder_csrbank9_rxempty_we = 1'd0;
wire builder_csrbank9_rxempty_w;
reg  builder_csrbank9_ev_status_re = 1'd0;
wire [1:0] builder_csrbank9_ev_status_r;
reg  builder_csrbank9_ev_status_we = 1'd0;
wire [1:0] builder_csrbank9_ev_status_w;
reg  builder_csrbank9_ev_pending_re = 1'd0;
wire [1:0] builder_csrbank9_ev_pending_r;
reg  builder_csrbank9_ev_pending_we = 1'd0;
wire [1:0] builder_csrbank9_ev_pending_w;
...
reg  builder_csrbank9_txempty_re = 1'd0;
wire builder_csrbank9_txempty_r;
reg  builder_csrbank9_txempty_we = 1'd0;
wire builder_csrbank9_txempty_w;
reg  builder_csrbank9_rxfull_re = 1'd0;
wire builder_csrbank9_rxfull_r;
reg  builder_csrbank9_rxfull_we = 1'd0;
...
reg  builder_csrbank11_medida_re = 1'd0;
wire [7:0] builder_csrbank11_medida_r;
reg  builder_csrbank11_medida_we = 1'd0;
wire [7:0] builder_csrbank11_medida_w;
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *) reg  [15:0] builder_xilinxmultiregimpl1_regs0 = 16'd0;
(* async_reg = "true", dont_touch = "true" *) reg  [15:0] builder_xilinxmultiregimpl1_regs1 = 16'd0;
...
assign {led15, led14, led13, led12, led11, led10, led9, led8, led7, led6, led5, led4, led3, led2, led1, led0} = basesoc_leds_storage;
...
assign builder_csrbank3_r_enable0_r = builder_interface3_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank3_r_enable0_we <= 1'd0;
	builder_csrbank3_r_enable0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank3_r_enable0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_r_enable0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_r_width0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_r_width0_we <= 1'd0;
	builder_csrbank3_r_width0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank3_r_width0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_r_width0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_r_period0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_r_period0_re <= 1'd0;
	builder_csrbank3_r_period0_we <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank3_r_period0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_r_period0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_g_enable0_r = builder_interface3_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank3_g_enable0_we <= 1'd0;
	builder_csrbank3_g_enable0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 2'd3))) begin
		builder_csrbank3_g_enable0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_g_enable0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_g_width0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_g_width0_re <= 1'd0;
	builder_csrbank3_g_width0_we <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 3'd4))) begin
		builder_csrbank3_g_width0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_g_width0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_g_period0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_g_period0_re <= 1'd0;
	builder_csrbank3_g_period0_we <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 3'd5))) begin
		builder_csrbank3_g_period0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_g_period0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_b_enable0_r = builder_interface3_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank3_b_enable0_we <= 1'd0;
	builder_csrbank3_b_enable0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 3'd6))) begin
		builder_csrbank3_b_enable0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_b_enable0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_b_width0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_b_width0_re <= 1'd0;
	builder_csrbank3_b_width0_we <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 3'd7))) begin
		builder_csrbank3_b_width0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_b_width0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_b_period0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_b_period0_we <= 1'd0;
	builder_csrbank3_b_period0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 4'd8))) begin
		builder_csrbank3_b_period0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_b_period0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_r_enable0_w = basesoc_ledRGB_1_r_enable_storage;
assign builder_csrbank3_r_width0_w = basesoc_ledRGB_1_r_width_storage[31:0];
assign builder_csrbank3_r_period0_w = basesoc_ledRGB_1_r_period_storage[31:0];
assign builder_csrbank3_g_enable0_w = basesoc_ledRGB_1_g_enable_storage;
assign builder_csrbank3_g_width0_w = basesoc_ledRGB_1_g_width_storage[31:0];
assign builder_csrbank3_g_period0_w = basesoc_ledRGB_1_g_period_storage[31:0];
assign builder_csrbank3_b_enable0_w = basesoc_ledRGB_1_b_enable_storage;
assign builder_csrbank3_b_width0_w = basesoc_ledRGB_1_b_width_storage[31:0];
assign builder_csrbank3_b_period0_w = basesoc_ledRGB_1_b_period_storage[31:0];
...
assign builder_csrbank4_r_enable0_w = basesoc_ledRGB_2_r_enable_storage;
assign builder_csrbank4_r_width0_w = basesoc_ledRGB_2_r_width_storage[31:0];
assign builder_csrbank4_r_period0_w = basesoc_ledRGB_2_r_period_storage[31:0];
assign builder_csrbank4_g_enable0_w = basesoc_ledRGB_2_g_enable_storage;
assign builder_csrbank4_g_width0_w = basesoc_ledRGB_2_g_width_storage[31:0];
assign builder_csrbank4_g_period0_w = basesoc_ledRGB_2_g_period_storage[31:0];
assign builder_csrbank4_b_enable0_w = basesoc_ledRGB_2_b_enable_storage;
assign builder_csrbank4_b_width0_w = basesoc_ledRGB_2_b_width_storage[31:0];
assign builder_csrbank4_b_period0_w = basesoc_ledRGB_2_b_period_storage[31:0];
assign builder_csrbank5_sel = (builder_interface5_bank_bus_adr[13:9] == 1'd0);
assign builder_csrbank5_out0_r = builder_interface5_bank_bus_dat_w[15:0];
always @(*) begin
...
assign builder_csrbank5_out0_w = basesoc_leds_storage[15:0];
assign builder_csrbank6_sel = (builder_interface6_bank_bus_adr[13:9] == 3'd6);
assign builder_csrbank6_ctr0_r = builder_interface6_bank_bus_dat_w[2:0];
always @(*) begin
	builder_csrbank6_ctr0_we <= 1'd0;
	builder_csrbank6_ctr0_re <= 1'd0;
	if ((builder_csrbank6_sel & (builder_interface6_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank6_ctr0_re <= builder_interface6_bank_bus_we;
		builder_csrbank6_ctr0_we <= (~builder_interface6_bank_bus_we);
	end
end
assign builder_csrbank6_ctr0_w = basesoc_servo_driver_storage[2:0];
assign builder_csrbank7_sel = (builder_interface7_bank_bus_adr[13:9] == 1'd1);
assign builder_csrbank7_in_r = builder_interface7_bank_bus_dat_w[15:0];
always @(*) begin
...
assign builder_csrbank7_in_w = basesoc_switchs_status[15:0];
assign basesoc_switchs_we = builder_csrbank7_in_we;
assign builder_csrbank8_sel = (builder_interface8_bank_bus_adr[13:9] == 4'd11);
assign builder_csrbank8_load0_r = builder_interface8_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank8_load0_re <= 1'd0;
	builder_csrbank8_load0_we <= 1'd0;
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank8_load0_re <= builder_interface8_bank_bus_we;
		builder_csrbank8_load0_we <= (~builder_interface8_bank_bus_we);
	end
end
assign builder_csrbank8_reload0_r = builder_interface8_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank8_reload0_re <= 1'd0;
	builder_csrbank8_reload0_we <= 1'd0;
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank8_reload0_re <= builder_interface8_bank_bus_we;
		builder_csrbank8_reload0_we <= (~builder_interface8_bank_bus_we);
	end
end
assign builder_csrbank8_en0_r = builder_interface8_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank8_en0_we <= 1'd0;
	builder_csrbank8_en0_re <= 1'd0;
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank8_en0_re <= builder_interface8_bank_bus_we;
		builder_csrbank8_en0_we <= (~builder_interface8_bank_bus_we);
	end
end
assign builder_csrbank8_update_value0_r = builder_interface8_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank8_update_value0_re <= 1'd0;
	builder_csrbank8_update_value0_we <= 1'd0;
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 2'd3))) begin
		builder_csrbank8_update_value0_re <= builder_interface8_bank_bus_we;
		builder_csrbank8_update_value0_we <= (~builder_interface8_bank_bus_we);
	end
end
assign builder_csrbank8_value_r = builder_interface8_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank8_value_we <= 1'd0;
	builder_csrbank8_value_re <= 1'd0;
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 3'd4))) begin
		builder_csrbank8_value_re <= builder_interface8_bank_bus_we;
		builder_csrbank8_value_we <= (~builder_interface8_bank_bus_we);
	end
end
...
always @(*) begin
	...
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 3'd6))) begin
...
always @(*) begin
	...
	if ((builder_csrbank8_sel & (builder_interface8_bank_bus_adr[8:0] == 3'd7))) begin
...
assign builder_csrbank8_ev_status_w = basesoc_basesoc_timer_status_status;
assign basesoc_basesoc_timer_status_we = builder_csrbank8_ev_status_we;
assign basesoc_basesoc_timer_pending_status = basesoc_basesoc_timer_zero1;
assign builder_csrbank8_ev_pending_w = basesoc_basesoc_timer_pending_status;
assign basesoc_basesoc_timer_pending_we = builder_csrbank8_ev_pending_we;
assign basesoc_basesoc_timer_zero2 = basesoc_basesoc_timer_enable_storage;
assign builder_csrbank8_ev_enable0_w = basesoc_basesoc_timer_enable_storage;
assign builder_csrbank9_sel = (builder_interface9_bank_bus_adr[13:9] == 4'd12);
...
always @(*) begin
	...
	if ((builder_csrbank9_sel & (builder_interface9_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_basesoc_uart_rxtx_re <= builder_interface9_bank_bus_we;
		basesoc_basesoc_uart_rxtx_we <= (~builder_interface9_bank_bus_we);
	end
end
assign builder_csrbank9_txfull_r = builder_interface9_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank9_txfull_we <= 1'd0;
	builder_csrbank9_txfull_re <= 1'd0;
	if ((builder_csrbank9_sel & (builder_interface9_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank9_txfull_re <= builder_interface9_bank_bus_we;
		builder_csrbank9_txfull_we <= (~builder_interface9_bank_bus_we);
	end
end
assign builder_csrbank9_rxempty_r = builder_interface9_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank9_rxempty_we <= 1'd0;
	builder_csrbank9_rxempty_re <= 1'd0;
	if ((builder_csrbank9_sel & (builder_interface9_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank9_rxempty_re <= builder_interface9_bank_bus_we;
		builder_csrbank9_rxempty_we <= (~builder_interface9_bank_bus_we);
	end
end
assign builder_csrbank9_ev_status_r = builder_interface9_bank_bus_dat_w[1:0];
always @(*) begin
...
assign builder_csrbank9_ev_pending_r = builder_interface9_bank_bus_dat_w[1:0];
always @(*) begin
...
always @(*) begin
	builder_csrbank9_txempty_re <= 1'd0;
	builder_csrbank9_txempty_we <= 1'd0;
	if ((builder_csrbank9_sel & (builder_interface9_bank_bus_adr[8:0] == 3'd6))) begin
		builder_csrbank9_txempty_re <= builder_interface9_bank_bus_we;
		builder_csrbank9_txempty_we <= (~builder_interface9_bank_bus_we);
	end
end
assign builder_csrbank9_rxfull_r = builder_interface9_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank9_rxfull_re <= 1'd0;
	builder_csrbank9_rxfull_we <= 1'd0;
	if ((builder_csrbank9_sel & (builder_interface9_bank_bus_adr[8:0] == 3'd7))) begin
		builder_csrbank9_rxfull_re <= builder_interface9_bank_bus_we;
		builder_csrbank9_rxfull_we <= (~builder_interface9_bank_bus_we);
	end
end
...
assign builder_csrbank9_ev_status_w = basesoc_basesoc_uart_status_status[1:0];
assign basesoc_basesoc_uart_status_we = builder_csrbank9_ev_status_we;
always @(*) begin
...
assign builder_csrbank9_ev_pending_w = basesoc_basesoc_uart_pending_status[1:0];
assign basesoc_basesoc_uart_pending_we = builder_csrbank9_ev_pending_we;
...
assign builder_csrbank9_ev_enable0_w = basesoc_basesoc_uart_enable_storage[1:0];
...
assign builder_csrbank10_sel = (builder_interface10_bank_bus_adr[13:9] == 4'd9);
assign basesoc_rxtx_r = builder_interface10_bank_bus_dat_w[7:0];
always @(*) begin
	basesoc_rxtx_we <= 1'd0;
	basesoc_rxtx_re <= 1'd0;
	if ((builder_csrbank10_sel & (builder_interface10_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_rxtx_re <= builder_interface10_bank_bus_we;
		basesoc_rxtx_we <= (~builder_interface10_bank_bus_we);
	end
end
...
assign builder_csrbank10_txfull_w = basesoc_txfull_status;
assign basesoc_txfull_we = builder_csrbank10_txfull_we;
assign builder_csrbank10_rxempty_w = basesoc_rxempty_status;
assign basesoc_rxempty_we = builder_csrbank10_rxempty_we;
always @(*) begin
	basesoc_status_status <= 2'd0;
	basesoc_status_status[0] <= basesoc_tx0;
	basesoc_status_status[1] <= basesoc_rx0;
end
assign builder_csrbank10_ev_status_w = basesoc_status_status[1:0];
assign basesoc_status_we = builder_csrbank10_ev_status_we;
always @(*) begin
	basesoc_pending_status <= 2'd0;
	basesoc_pending_status[0] <= basesoc_tx1;
	basesoc_pending_status[1] <= basesoc_rx1;
end
assign builder_csrbank10_ev_pending_w = basesoc_pending_status[1:0];
assign basesoc_pending_we = builder_csrbank10_ev_pending_we;
assign basesoc_tx2 = basesoc_enable_storage[0];
assign basesoc_rx2 = basesoc_enable_storage[1];
assign builder_csrbank10_ev_enable0_w = basesoc_enable_storage[1:0];
assign builder_csrbank10_txempty_w = basesoc_txempty_status;
assign basesoc_txempty_we = builder_csrbank10_txempty_we;
assign builder_csrbank10_rxfull_w = basesoc_rxfull_status;
assign basesoc_rxfull_we = builder_csrbank10_rxfull_we;
assign builder_csrbank11_sel = (builder_interface11_bank_bus_adr[13:9] == 3'd7);
assign builder_csrbank11_medida_r = builder_interface11_bank_bus_dat_w[7:0];
always @(*) begin
	builder_csrbank11_medida_re <= 1'd0;
	builder_csrbank11_medida_we <= 1'd0;
	if ((builder_csrbank11_sel & (builder_interface11_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank11_medida_re <= builder_interface11_bank_bus_we;
		builder_csrbank11_medida_we <= (~builder_interface11_bank_bus_we);
	end
end
assign builder_csrbank11_medida_w = basesoc_us_driver_status[7:0];
assign basesoc_us_driver_we = builder_csrbank11_medida_we;
...
assign builder_xilinxmultiregimpl1 = {sw15, sw14, sw13, sw12, sw11, sw10, sw9, sw8, sw7, sw6, sw5, sw4, sw3, sw2, sw1, sw0};
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank3_sel) begin
		case (builder_interface3_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_r_enable0_w;
			end
			1'd1: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_r_width0_w;
			end
			2'd2: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_r_period0_w;
			end
			2'd3: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_g_enable0_w;
			end
			3'd4: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_g_width0_w;
			end
			3'd5: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_g_period0_w;
			end
			3'd6: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_b_enable0_w;
			end
			3'd7: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_b_width0_w;
			end
			4'd8: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_b_period0_w;
			end
		endcase
	end
	if (builder_csrbank3_r_enable0_re) begin
		basesoc_ledRGB_1_r_enable_storage <= builder_csrbank3_r_enable0_r;
	end
	basesoc_ledRGB_1_r_enable_re <= builder_csrbank3_r_enable0_re;
	if (builder_csrbank3_r_width0_re) begin
		basesoc_ledRGB_1_r_width_storage[31:0] <= builder_csrbank3_r_width0_r;
	end
	basesoc_ledRGB_1_r_width_re <= builder_csrbank3_r_width0_re;
	if (builder_csrbank3_r_period0_re) begin
		basesoc_ledRGB_1_r_period_storage[31:0] <= builder_csrbank3_r_period0_r;
	end
	basesoc_ledRGB_1_r_period_re <= builder_csrbank3_r_period0_re;
	if (builder_csrbank3_g_enable0_re) begin
		basesoc_ledRGB_1_g_enable_storage <= builder_csrbank3_g_enable0_r;
	end
	basesoc_ledRGB_1_g_enable_re <= builder_csrbank3_g_enable0_re;
	if (builder_csrbank3_g_width0_re) begin
		basesoc_ledRGB_1_g_width_storage[31:0] <= builder_csrbank3_g_width0_r;
	end
	basesoc_ledRGB_1_g_width_re <= builder_csrbank3_g_width0_re;
	if (builder_csrbank3_g_period0_re) begin
		basesoc_ledRGB_1_g_period_storage[31:0] <= builder_csrbank3_g_period0_r;
	end
	basesoc_ledRGB_1_g_period_re <= builder_csrbank3_g_period0_re;
	if (builder_csrbank3_b_enable0_re) begin
		basesoc_ledRGB_1_b_enable_storage <= builder_csrbank3_b_enable0_r;
	end
	basesoc_ledRGB_1_b_enable_re <= builder_csrbank3_b_enable0_re;
	if (builder_csrbank3_b_width0_re) begin
		basesoc_ledRGB_1_b_width_storage[31:0] <= builder_csrbank3_b_width0_r;
	end
	basesoc_ledRGB_1_b_width_re <= builder_csrbank3_b_width0_re;
	if (builder_csrbank3_b_period0_re) begin
		basesoc_ledRGB_1_b_period_storage[31:0] <= builder_csrbank3_b_period0_r;
	end
	basesoc_ledRGB_1_b_period_re <= builder_csrbank3_b_period0_re;
	...
	if (builder_csrbank4_r_enable0_re) begin
		basesoc_ledRGB_2_r_enable_storage <= builder_csrbank4_r_enable0_r;
	end
	basesoc_ledRGB_2_r_enable_re <= builder_csrbank4_r_enable0_re;
	if (builder_csrbank4_r_width0_re) begin
		basesoc_ledRGB_2_r_width_storage[31:0] <= builder_csrbank4_r_width0_r;
	end
	basesoc_ledRGB_2_r_width_re <= builder_csrbank4_r_width0_re;
	if (builder_csrbank4_r_period0_re) begin
		basesoc_ledRGB_2_r_period_storage[31:0] <= builder_csrbank4_r_period0_r;
	end
	basesoc_ledRGB_2_r_period_re <= builder_csrbank4_r_period0_re;
	if (builder_csrbank4_g_enable0_re) begin
		basesoc_ledRGB_2_g_enable_storage <= builder_csrbank4_g_enable0_r;
	end
	basesoc_ledRGB_2_g_enable_re <= builder_csrbank4_g_enable0_re;
	if (builder_csrbank4_g_width0_re) begin
		basesoc_ledRGB_2_g_width_storage[31:0] <= builder_csrbank4_g_width0_r;
	end
	basesoc_ledRGB_2_g_width_re <= builder_csrbank4_g_width0_re;
	if (builder_csrbank4_g_period0_re) begin
		basesoc_ledRGB_2_g_period_storage[31:0] <= builder_csrbank4_g_period0_r;
	end
	basesoc_ledRGB_2_g_period_re <= builder_csrbank4_g_period0_re;
	if (builder_csrbank4_b_enable0_re) begin
		basesoc_ledRGB_2_b_enable_storage <= builder_csrbank4_b_enable0_r;
	end
	basesoc_ledRGB_2_b_enable_re <= builder_csrbank4_b_enable0_re;
	if (builder_csrbank4_b_width0_re) begin
		basesoc_ledRGB_2_b_width_storage[31:0] <= builder_csrbank4_b_width0_r;
	end
	basesoc_ledRGB_2_b_width_re <= builder_csrbank4_b_width0_re;
	if (builder_csrbank4_b_period0_re) begin
		basesoc_ledRGB_2_b_period_storage[31:0] <= builder_csrbank4_b_period0_r;
	end
	basesoc_ledRGB_2_b_period_re <= builder_csrbank4_b_period0_re;
	...
	if (builder_csrbank5_out0_re) begin
		basesoc_leds_storage[15:0] <= builder_csrbank5_out0_r;
	end
	...
	if (builder_csrbank6_sel) begin
		case (builder_interface6_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_ctr0_w;
			end
		endcase
	end
	if (builder_csrbank6_ctr0_re) begin
		basesoc_servo_driver_storage[2:0] <= builder_csrbank6_ctr0_r;
	end
	basesoc_servo_driver_re <= builder_csrbank6_ctr0_re;
	...
	basesoc_switchs_re <= builder_csrbank7_in_re;
	...
	basesoc_basesoc_timer_value_re <= builder_csrbank8_value_re;
	basesoc_basesoc_timer_status_re <= builder_csrbank8_ev_status_re;
	if (builder_csrbank8_ev_pending_re) begin
		basesoc_basesoc_timer_pending_r <= builder_csrbank8_ev_pending_r;
	end
	basesoc_basesoc_timer_pending_re <= builder_csrbank8_ev_pending_re;
	if (builder_csrbank8_ev_enable0_re) begin
		basesoc_basesoc_timer_enable_storage <= builder_csrbank8_ev_enable0_r;
	end
	basesoc_basesoc_timer_enable_re <= builder_csrbank8_ev_enable0_re;
	...
	basesoc_basesoc_uart_txfull_re <= builder_csrbank9_txfull_re;
	basesoc_basesoc_uart_rxempty_re <= builder_csrbank9_rxempty_re;
	basesoc_basesoc_uart_status_re <= builder_csrbank9_ev_status_re;
	if (builder_csrbank9_ev_pending_re) begin
		basesoc_basesoc_uart_pending_r[1:0] <= builder_csrbank9_ev_pending_r;
	end
	basesoc_basesoc_uart_pending_re <= builder_csrbank9_ev_pending_re;
	if (builder_csrbank9_ev_enable0_re) begin
		basesoc_basesoc_uart_enable_storage[1:0] <= builder_csrbank9_ev_enable0_r;
	end
	basesoc_basesoc_uart_enable_re <= builder_csrbank9_ev_enable0_re;
	basesoc_basesoc_uart_txempty_re <= builder_csrbank9_txempty_re;
	basesoc_basesoc_uart_rxfull_re <= builder_csrbank9_rxfull_re;
	builder_interface10_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank10_sel) begin
		case (builder_interface10_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface10_bank_bus_dat_r <= basesoc_rxtx_w;
			end
			1'd1: begin
	...
	basesoc_txfull_re <= builder_csrbank10_txfull_re;
	basesoc_rxempty_re <= builder_csrbank10_rxempty_re;
	basesoc_status_re <= builder_csrbank10_ev_status_re;
	if (builder_csrbank10_ev_pending_re) begin
		basesoc_pending_r[1:0] <= builder_csrbank10_ev_pending_r;
	end
	basesoc_pending_re <= builder_csrbank10_ev_pending_re;
	if (builder_csrbank10_ev_enable0_re) begin
		basesoc_enable_storage[1:0] <= builder_csrbank10_ev_enable0_r;
	end
	basesoc_enable_re <= builder_csrbank10_ev_enable0_re;
	basesoc_txempty_re <= builder_csrbank10_txempty_re;
	basesoc_rxfull_re <= builder_csrbank10_rxfull_re;
	builder_interface11_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank11_sel) begin
		case (builder_interface11_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface11_bank_bus_dat_r <= builder_csrbank11_medida_w;
			end
		endcase
	end
	basesoc_us_driver_re <= builder_csrbank11_medida_re;
	if (sys_rst) begin
		...
		basesoc_servo_driver_storage <= 3'd0;
		basesoc_servo_driver_re <= 1'd0;
		basesoc_us_driver_re <= 1'd0;
		uart1_tx <= 1'd1;
	...
	builder_xilinxmultiregimpl1_regs0 <= {sw15, sw14, sw13, sw12, sw11, sw10, sw9, sw8, sw7, sw6, sw5, sw4, sw3, sw2, sw1, sw0};
...
//------------------------------------------------------------------------------
// Memory rom: 5483-words x 32-bit
//------------------------------------------------------------------------------
...
ServoRadar ServoRadar(
	.clk(sys_clk),
	.ctr(basesoc_servo_driver_storage),
	.pwm(pwm)
);

sensor_prueba sensor_prueba(
	.CLK(sys_clk),
	.ECO(ECO),
	.TRIGGER(TRIGGER),
	.medida(basesoc_us_driver_status)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-06-30 12:44:23.
//------------------------------------------------------------------------------
